...
public class ScreenCaptureManager : MonoBehaviour
{
    ...
    static ScreenCaptureManager instance = null;
    ...
    public static ScreenCaptureManager Instance
    {
        get
        {
            ...
            {
                go = new GameObject();
                go.name = "ScreenCaptureManager";
                instance = go.AddComponent<ScreenCaptureManager>();
    ...
    public static void SaveScreenshot(string fileName, string albumName = "MyScreenshots", string fileType = "jpg",
        Rect screenArea = default(Rect))
    {
    ...
    public static void SaveImage(Texture2D texture, string fileName, string albumName = "MyImages",
        string fileType = "jpg")
    {
